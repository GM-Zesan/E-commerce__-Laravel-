					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							@foreach ($product_sub_images as $img)
								<div class="item-slick3" data-thumb="{{  url($img->sub_image) }}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{  url($img->sub_image) }}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{  url($img->sub_image) }}">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							{{ $product->products_price }} BDT
						</span>

						<p class="stext-102 cl3 p-t-23">
                            {{ $product->products_short_desc }}
						</p>
						
						<!--  -->
						<div class="p-t-33">
							<form id="src" action="{{ route('insert.cart') }}" method="post">
								@csrf
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next form-group">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2 form-control" name="size_id">
												<option value="">Select Size</option>
												@foreach ($product_size as $size)
													<option 
													value="{{ $size->sizes_id }}">
													{{ $size['size']['sizes_name'] }}</option>
												@endforeach
											</select>
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next form-group">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2 form-control" name="color_id">
												<option value="">Select Color</option>
												@foreach ($product_color as $color)
													<option value="{{ $color->colors_id }}">{{ $color['color']['colors_name'] }}</option>
												@endforeach
											</select>
											<div class="dropDownSelect2"></div>
											<font style="color: red">
